<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TicketStatus.aspx.cs" Inherits="DigiAgro.Tickets.TicketStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <tr >
                        <td align="right" class="style1" width="30%">
                                    <asp:Label ID="Label2" runat="server" Text="Status Discription :"></asp:Label>
                                </td>
                        <td style="width: 1%;" align="right" colspan="1">
                            &nbsp;</td>
                        <td class="style2" width="60%" >
                                    <asp:TextBox ID="txtStatusDiscription" runat="server"></asp:TextBox>
                        </td>
