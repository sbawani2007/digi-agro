<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Owais.aspx.cs" Inherits="DigiAgro.Owais" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="pnlmain" runat="server">
        <table style="width: 804px" runat="server" id="tblmain">
            ...
            <tr>
                <td align="right" class="style1" width="30%">
                    <asp:Label ID="Label7" runat="server" Text="IdNumber :"></asp:Label>
                </td>
                <td style="width: 1%;" align="right" colspan="1">
                    &nbsp;
                </td>
