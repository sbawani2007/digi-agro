...
namespace DigiAgro.Manager
{
    public class AhmedManager
    {
        ...
        public AhmedManager()
        {
            ...
            bllAhmedObj = new BLL.AhmedBLL();
            bll_utility = new BLL.Utility();
        }

        public Int32 Insert(BOL.AhmedBOL obj)
        {
            if (obj != null)
            {
                try
                {
                    ...
                    bllAhmedObj.Insert(obj, conn, trans);
        ...
        public Int32 Update(BOL.AhmedBOL obj)
        {
            if (obj != null)
            {
                try
                {
                    ...
                    bllAhmedObj.Update(obj, conn, trans);
        ...
        public Int32 Delete(BOL.AhmedBOL obj)
        {
            if (obj != null)
            {
                try
                {
                    ...
                    bllAhmedObj.Delete(obj, conn, trans);
        ...
        public List<BOL.customers> Select(BOL.AhmedBOL obj)
        {
            //if (obj != null)
            //{
            //    conn = new MySqlConnection(ConnectionString);
