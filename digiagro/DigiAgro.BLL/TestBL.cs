...
//        public Int32 Insert(BOL c, MySqlConnection conn, MySqlTransaction trans)
//        {
//            if (c != null)
//            {
//                try
//                {
//                    string qry = @"INSERT INTO `test`(  `testName`, `testEmail`, `testLastName`) 
//                        VALUES ('" + c.TestName + "','" + c.TestEmail + "','" + c.TestLastName
//                                   + "')";
